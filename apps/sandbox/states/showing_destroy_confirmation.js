Sandbox.SHOWING_DESTROY_CONFIRMATION = SC.State.design({
  _panel: null,

  enterState: function() {
    var displayDescription = "Are you sure that you wish to clear the following tasks?<br /><br />";
    var completedTodos = Sandbox.completedTodosController;
  ...
  confirm: function() {
    Sandbox.completedTodosController.invoke('destroy');
